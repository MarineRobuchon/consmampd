---
title: "Re-identifying species and areas of interest to conserve global mammalian phylogenetic diversity"
author: Github repository & scripts created by Marine Robuchon, with contributions of Boris Leroy & Sandrine Pavoine
output: 
  # html_document: 
  #   theme: united
  #   toc: true
...
+ Complete_phylogeny.nex (file containing phylogenetic trees)
+ Trait_data.csv (file containing trait data)
...
+ scores_Mammals_median-over-the-100-resolved-trees.csv (file containing median HEDGE, LEDGE and HED scores over the 100 trees)
+ phylori_Mammals_median-over-the-100-resolved-trees.csv (file containing median scores of phylogenetic originality over the 100 trees)
...
Download the supplementary files MAMMALS.shp, .shx, .sbx, .sbn, .prj, .dbf, .cpg and place them into the folder "requireddata".
QUESTION: where to we put these big files (1.45 Go)? Dryad?
